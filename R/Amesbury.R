...
#'
#' @format ## `Amesbury`
#' This dataset contains provides the data from Amesbury (2016). In essence, it's a Testate amoebae community table (45 broad) TA taxa and 1103 samples)
#' \describe{
...
#'   \item{coords}{a dataframe containing the coordinates of each sample}
#'   ...
#' }
#' @source <https://doi.org/10.1016/j.quascirev.2016.09.024>
#' @references 
...
#' \emph{Development of a new pan-European testate amoeba transfer function for reconstructing peatland palaeohydrology.
#' Quaternary Science Reviews, vol. 152, 2016, pages 132-151}.
#' \doi{10.1016/j.quascirev.2016.09.024}.\cr
"Amesbury"